...
// <p className="parag"><h3 className="schoolYear">New York, NY | August 2024 – Present</h3></p>
...
// <p className="parag"><h3 className="schoolYear">Remote | February 2023 – October 2023</h3></p>
...
// <p className="parag"><h3 className="schoolYear">Abidjan, Côte d’Ivoire | 2016 – 2019</h3></p>
